...
async function allMenu(sock, from, msg, session, commands) {
    // ===== HEAVY BOX HEADER =====
    let allMenuText = `┏━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┓\n`;
    allMenuText += `┃  💀  *THUG MINI ALL MENU*  💀               ┃\n`;
    allMenuText += `┣━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━┫\n`;
    ...
    const categories = {
        ...
        '✏️ TEXT MAKER': ['THUG', 'cup', 'coffee', 'cloud', 'smoke', 'flower', 'leaf', 'wood', 'stone', 'blood', 'horror', 'scary', 'spooky', 'christmas', 'birthday', 'love', 'heart']
    };
    ...
    // ===== FOOTER =====
    allMenuText += `☠️  *POWERED BY : THUG MINI*  ☠️`;
